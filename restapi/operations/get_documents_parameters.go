...
func (o *GetDocumentsParams) bindCollection(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetDocumentsParams) bindProperty(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetDocumentsParams) bindValue(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
