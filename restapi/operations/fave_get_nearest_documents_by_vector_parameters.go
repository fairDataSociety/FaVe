...
func NewFaveGetNearestDocumentsByVectorParams() FaveGetNearestDocumentsByVectorParams {
	...
	return FaveGetNearestDocumentsByVectorParams{}
}

// FaveGetNearestDocumentsByVectorParams contains all the bound params for the fave get nearest documents by vector operation
