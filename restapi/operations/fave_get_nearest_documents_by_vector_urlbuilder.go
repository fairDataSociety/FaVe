...
func (o *FaveGetNearestDocumentsByVectorURL) Build() (*url.URL, error) {
	...
	var _path = "/nearest-documents-by-vector"
...
func (o *FaveGetNearestDocumentsByVectorURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on FaveGetNearestDocumentsByVectorURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on FaveGetNearestDocumentsByVectorURL")
	}
