...
func NewFaveAddDocumentsParams() FaveAddDocumentsParams {
	...
	return FaveAddDocumentsParams{}
}

// FaveAddDocumentsParams contains all the bound params for the fave add documents operation
...
func (o *FaveAddDocumentsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.AddDocumentsRequest
