...
func NewFaveGetNearestDocumentsParams() FaveGetNearestDocumentsParams {
	...
	return FaveGetNearestDocumentsParams{}
}

// FaveGetNearestDocumentsParams contains all the bound params for the fave get nearest documents operation
...
func (o *FaveGetNearestDocumentsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.NearestDocumentsRequest
